    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            hdri_url: URL to an HDRI environment map (.hdr or .exr) for realistic lighting. If not provided, default lighting is used.
            scale_mm: Scale factor to convert model units to millimeters for measurement display. Default is 100.
            show_measurements: If True, enables measurement tools to measure distances between points on the model.
